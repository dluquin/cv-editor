...
function Experience({ data, onChange, errors = {} }) {
    ...
    const getInputValue = (dateStr) => {
        ...
        // If it's MM-YYYY (old format), convert to YYYY-MM
        if (dateStr.match(/^\d{2}-\d{4}$/)) {
            const [month, year] = dateStr.split('-');
            return `${year}-${month}`;
        }
        // If it's just YYYY, default to January
                        ...
                        <div className="grid-2">
                            <div className="form-group">
                                ...
                                <input
                                    ...
                                    className={itemErrors.cargo ? 'invalid' : ''}
                                />
                            </div>
                            <div className="form-group">
                                <label>Empresa</label>
